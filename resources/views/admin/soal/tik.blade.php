    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">Tambah Soal TIK</div>
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form id="form_soal" action="{{ action('SoalController@storeTik') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">Soal TIK : {{$soals->count()}} Soal</div>
                            ...
                            <div class="panel panel-danger" id="toggle{{$index}}">
                                <div class="panel-heading" id="headingSoal{{$index}}">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-1">
                                            <form action="{{url('soal/tik/'.$soal->id)}}" style="display:inline-block" method="POST">
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE') }}
